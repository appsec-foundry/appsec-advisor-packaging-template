...
| `org-profile/baselines/organization-overlay.md` | Optional org-owned rules appended to the baseline at build time, never touched by `make baseline-sync` — see `org-profile/baselines/README.md` |
